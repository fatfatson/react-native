 ...
 */ let traverseDependencies = (() => {
  var _ref = _asyncToGenerator(function*(paths, graph, options) {
    const delta = {
      added: new Map(),
      modified: new Map(),
      deleted: new Set(),
    ...
    for (const _ref3 of delta.added) {
      ...
      const path = _ref4[0];
      const module = _ref4[1];
      added.set(path, module);
    }

    for (const _ref5 of delta.modified) {
      var _ref6 = _slicedToArray(_ref5, 2);
      const path = _ref6[0];
      const module = _ref6[1];
      added.set(path, module);
 ...
 **/ let initialTraverseDependencies = (() => {
  var _ref7 = _asyncToGenerator(function*(graph, options) {
    graph.entryPoints.forEach(function(entryPoint) {
      return createModule(entryPoint, graph);
    });
  ...
  return function initialTraverseDependencies(_x5, _x6) {
    return _ref7.apply(this, arguments);
  };
})();
let traverseDependenciesForSingleFile = (() => {
  var _ref8 = _asyncToGenerator(function*(module, graph, delta, options) {
    let numProcessed = 0;
    let total = 1;
  ...
  return function traverseDependenciesForSingleFile(_x7, _x8, _x9, _x10) {
...
let processModule = (() => {
  var _ref9 = _asyncToGenerator(function*(
    ...
    for (const _ref12 of previousDependencies) {
      var _ref13 = _slicedToArray(_ref12, 2);
      const relativePath = _ref13[0];
      const dependency = _ref13[1];
    ...
    for (const _ref14 of currentDependencies) {
      var _ref15 = _slicedToArray(_ref14, 2);
      const relativePath = _ref15[0];
      const dependency = _ref15[1];
  ...
  return function processModule(_x11, _x12, _x13, _x14, _x15, _x16) {
...
function removeDependency(parentModule, absolutePath, graph, delta) {
  ...
  // been deleted).
  for (const _ref17 of module.dependencies) {
    var _ref18 = _slicedToArray(_ref17, 2);
    const dependency = _ref18[1];
    removeDependency(module, dependency.absolutePath, graph, delta);
  }
