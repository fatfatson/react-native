...
const initialTraverseDependencies = _require.initialTraverseDependencies,
...
class DeltaCalculator extends EventEmitter {
  constructor(entryPoints, dependencyGraph, options) {
    ...
    this._graph = {dependencies: new Map(), entryPoints};
    ...
    return _asyncToGenerator(function*() {
      ...
      try {
        ...
        modifiedFiles.forEach(function(file) {
          return _this._modifiedFiles.add(file);
        });
        deletedFiles.forEach(function(file) {
          return _this._deletedFiles.add(file);
      ...
      if (reset) {
        ...
        return {
          modified: _this._graph.dependencies,
          deleted: new Set(),
          reset: true,
        };
      }
   ...
   */ _getChangedDependencies(modifiedFiles, deletedFiles) {
    ...
    return _asyncToGenerator(function*() {
      if (!_this2._graph.dependencies.size) {
        var _ref4 = yield initialTraverseDependencies(
          _this2._graph,
          _this2._options,
        );
        const added = _ref4.added;
        return {modified: added, deleted: new Set(), reset: true};
      ...
      const modifiedDependencies = Array.from(modifiedFiles).filter(function(
        filePath,
      ) {
        return _this2._graph.dependencies.has(filePath);
      });
      ...
      var _ref5 = yield traverseDependencies(
        modifiedDependencies,
        _this2._graph,
        _this2._options,
      );
      const added = _ref5.added,
