...
class Server {
  constructor(options) {
    ...
    /* eslint-disable no-unused-vars */ var _opts = this._opts;
    const createModuleId = _opts.createModuleId,
      getModulesRunBeforeMainModule = _opts.getModulesRunBeforeMainModule,
      getRunModuleStatement = _opts.getRunModuleStatement,
      silent = _opts.silent,
      bundlerOptionsFromServerOptions = _objectWithoutProperties(_opts, [
        'createModuleId',
    ...
    this._bundler = new Bundler(
      _extends({}, bundlerOptionsFromServerOptions, {
    ...
    this._bundler.getDependencyGraph().then(dependencyGraph => {
      dependencyGraph.getWatcher().on('change', _ref2 => {
  ...
  buildGraph(entryFiles, options) {
    ...
    return _asyncToGenerator(function*() {
      entryFiles = entryFiles.map(function(entryFile) {
        return getAbsolutePath(entryFile, _this2._opts.projectRoots);
      });
  ...
  getAssets(options) {
    var _this4 = this;
    return _asyncToGenerator(function*() {
      var _ref3 = yield _this4._buildGraph(options);
      const graph = _ref3.graph;
  ...
  _getGraphInfo(options, _ref5) {
    var _this7 = this;
    let rebuild = _ref5.rebuild;
    return _asyncToGenerator(function*() {
  ...
  _processDeltaRequest(req, res) {
    ...
    return _asyncToGenerator(function*() {
      ...
      var _prepareDeltaBundler = _this10._prepareDeltaBundler(req, mres);
      ...
      try {
        ...
        var _ref6 = yield _this10._getDeltaInfo(options);
        delta = _ref6.delta;
        graph = _ref6.graph;
        prepend = _ref6.prepend;
  ...
  _processBundleRequest(req, res) {
    ...
    return _asyncToGenerator(function*() {
      const mres = MultipartResponse.wrap(req, res);
      var _prepareDeltaBundler2 = _this11._prepareDeltaBundler(req, mres);
      ...
      try {
        var _ref7 = yield _this11._getGraphInfo(options, {rebuild: true});
        const graph = _ref7.graph,
          prepend = _ref7.prepend,
          lastModified = _ref7.lastModified,
          numModifiedFiles = _ref7.numModifiedFiles;
  ...
  _processSourceMapRequest(req, res) {
    ...
    return _asyncToGenerator(function*() {
      const mres = MultipartResponse.wrap(req, res);
      var _prepareDeltaBundler3 = _this12._prepareDeltaBundler(req, mres);
      ...
      try {
        var _ref8 = yield _this12._getGraphInfo(options, {
          rebuild: false,
        });
  ...
  _processAssetsRequest(req, res) {
    ...
    return _asyncToGenerator(function*() {
      const mres = MultipartResponse.wrap(req, res);
      var _prepareDeltaBundler4 = _this13._prepareDeltaBundler(req, mres);
  ...
  _sourceMapForURL(reqUrl) {
    var _this14 = this;
    return _asyncToGenerator(function*() {
      const options = _this14._getOptionsFromUrl(reqUrl);
      var _ref9 = yield _this14._getGraphInfo(options, {
        rebuild: false,
      });
  ...
  this.processRequest = (() => {
    var _ref10 = _asyncToGenerator(function*(req, res, next) {
      ...
      if (pathname.match(/\.bundle$/)) {
        yield _this15._processBundleRequest(req, res);
      } else if (pathname.match(/\.map$/)) {
        yield _this15._processSourceMapRequest(req, res);
      } else if (pathname.match(/\.assets$/)) {
        yield _this15._processAssetsRequest(req, res);
      } else if (pathname.match(/\.delta$/)) {
        yield _this15._processDeltaRequest(req, res);
      } else if (pathname.match(/^\/onchange\/?$/)) {
        _this15._processOnChangeRequest(req, res);
      } else if (pathname.match(/^\/assets\//)) {
        yield _this15._processSingleAssetRequest(req, res);
      } else if (pathname === '/symbolicate') {
        _this15._symbolicate(req, res);
      } else if (next) {
        next();
      } else {
        res.writeHead(404);
