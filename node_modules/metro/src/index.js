...
let asyncRealpath = (() => {var _ref = _asyncToGenerator(function* (path) {
  ...
  {let config = _ref3.config;var _ref3$resetCache = _ref3.resetCache;let resetCache = _ref3$resetCache === undefined ? false : _ref3$resetCache;var _ref3$maxWorkers = _ref3.maxWorkers;let maxWorkers = _ref3$maxWorkers === undefined ? getMaxWorkers() : _ref3$maxWorkers,minifierPath = _ref3.minifierPath;var _ref3$port = _ref3.port;let port = _ref3$port === undefined ? null : _ref3$port;var _ref3$reporter = _ref3.reporter;let reporter = _ref3$reporter === undefined ? new TerminalReporter(new Terminal(process.stdout)) : _ref3$reporter;var _ref3$watch = _ref3.watch;let watch = _ref3$watch === undefined ? false : _ref3$watch;
...
exports.buildGraph = (() => {var _ref11 = _asyncToGenerator(function* (_ref12)
  ...
  {let config = _ref12.config;var _ref12$customTransfor = _ref12.customTransformOptions;let customTransformOptions = _ref12$customTransfor === undefined ? Object.create(null) : _ref12$customTransfor;var _ref12$dev = _ref12.dev;let dev = _ref12$dev === undefined ? false : _ref12$dev,entries = _ref12.entries;var _ref12$minify = _ref12.minify;let minify = _ref12$minify === undefined ? false : _ref12$minify,onProgress = _ref12.onProgress;var _ref12$platform = _ref12.platform;let platform = _ref12$platform === undefined ? `web` : _ref12$platform;var _ref12$type = _ref12.type;let type = _ref12$type === undefined ? 'module' : _ref12$type,rest = _objectWithoutProperties(_ref12, ['config', 'customTransformOptions', 'dev', 'entries', 'minify', 'onProgress', 'platform', 'type']);
    const metroServer = yield runMetro(_extends({},
    rest, {
      config }));
  ...
  });return function (_x6) {return _ref11.apply(this, arguments);};})();
...
{var _ref13 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},_ref13$cwd = _ref13.cwd;let cwd = _ref13$cwd === undefined ? process.cwd() : _ref13$cwd;var _ref13$basename = _ref13.basename;let basename = _ref13$basename === undefined ? METRO_CONFIG_FILENAME : _ref13$basename;var _ref13$strict = _ref13.strict;let strict = _ref13$strict === undefined ? false : _ref13$strict;
  if (filename) {
...
{var _ref14 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},_ref14$build = _ref14.build;let build = _ref14$build === undefined ? {} : _ref14$build;var _ref14$serve = _ref14.serve;let serve = _ref14$serve === undefined ? {} : _ref14$serve;
