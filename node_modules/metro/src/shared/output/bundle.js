...
let saveBundleAndMap = (() => {
  var _ref = _asyncToGenerator(function*(bundle, options, log) {
    ...
    yield Promise.all(
      writeFns.map(function(cb) {
        return cb();
      }),
    );
  });
  return function saveBundleAndMap(_x, _x2, _x3) {
...
function buildBundle(packagerClient, requestOptions) {
  return packagerClient.build(
    _extends({}, Server.DEFAULT_BUNDLE_OPTIONS, requestOptions, {
      bundleType: 'bundle',
    }),
  );
}
